...
that says so. On this repository it creates <span data-fact="checks">nine</span> check definitions, ten Python
transforms, three artifact definitions, one generator definition and <span data-fact="queries">twenty</span>
GraphQL queries.
