...
spans. On that plant sit 441 devices, 1490 ports, 40 pre-provisioned wavelengths
...
The object load takes a few minutes for 2344 objects. Files load in sorted
