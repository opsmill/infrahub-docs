...
sections and <span data-fact="spans">133</span> fiber spans. On that plant sit <span data-fact="devices">441</span> devices,
<span data-fact="ports">1490</span> ports, 40 pre-provisioned wavelengths
...
The object load takes a few minutes for <span data-fact="objects">2344</span> objects. Files load in sorted
...
It counts <span data-fact="optical-elements">554</span> optical elements and
<span data-fact="wavelengths">40</span> carriers, then ranks the sections by
...
element generic. The three ODU switches are present, because they inherit the
same generic.
