---
title: How to install Infrahub Backup & Restore Tool
---

import Tabs from '@theme/Tabs';
import TabItem from '@theme/TabItem';

This guide shows you how to install the Infrahub Backup & Restore Tool on your system.

## Prerequisites

Before installing the Infrahub Backup & Restore Tool, ensure you have:
...
To install the Infrahub Backup & Restore Tool, build from source:
...
The Infrahub Backup & Restore Tool use environment variables for configuration. Set these based on your deployment:
