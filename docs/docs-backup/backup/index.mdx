...
- Rotate archives with a [retention policy](./retention.mdx) that matches your recovery point objectives, and replicate critical backups to an off-site location.
