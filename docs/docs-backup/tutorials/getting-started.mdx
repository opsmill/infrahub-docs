---
title: Getting Started with the Infrahub Backup & Restore Tool
---

import Tabs from '@theme/Tabs';
import TabItem from '@theme/TabItem';

This tutorial walks you through your first experience with the Infrahub Backup & Restore Tool, teaching you the fundamentals by creating a backup of your Infrahub instance and then restoring it. By the end of this tutorial, you'll understand the basic workflow and be confident in using `infrahub-backup` for essential maintenance tasks.
...
Congratulations! You've completed your first backup and restore cycle with the Infrahub Backup & Restore Tool. You now know how to:
