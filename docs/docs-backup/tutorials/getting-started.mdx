---
title: Get started with Infrahub Backup
---

import Tabs from '@theme/Tabs';
import TabItem from '@theme/TabItem';

By the end of this tutorial you will have installed `infrahub-backup`, detected your deployment environment, created and verified your first backup — including a snapshot of artifact storage — and restored from it. That is the core maintenance workflow for an Infrahub instance on Docker Compose.
...
To complete the learning cycle, let's restore from the backup you created. This simulates recovering from a disaster or rolling back changes.
...
You've completed a full backup and restore cycle. You now know how to:
...
- [Restore from a backup](../backup/restore.mdx)
