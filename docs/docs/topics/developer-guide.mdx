...
| Command                        | Description                                                  |
|--------------------------------|--------------------------------------------------------------|
| [`infrahubctl transform`]($(base_url)infrahubctl/infrahubctl-transform.mdx) | Execute Python transforms locally.                          |
| [`infrahubctl render`]($(base_url)infrahubctl/infrahubctl-render.mdx)       | Render Jinja2 transforms locally.                           |
| [`infrahubctl generator`]($(base_url)infrahubctl/infrahubctl-generator.mdx) | Test custom generators.                                     |
| [`infrahubctl check`]($(base_url)infrahubctl/infrahubctl-check.mdx)         | Run local checks                                            |
