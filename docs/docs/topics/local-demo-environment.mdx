...
The system that you want to use to run the demo environment has to meet the [hardware requirements](./hardware-requirements). Alternatively you can run Infrahub in [GitHub codespaces](../guides/installation#github-codespaces).
