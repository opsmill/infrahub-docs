...
GraphQL is the primary API to interact with data, and allows access to everything defined by the schema. The [Python SDK]($(base_url)dointroduction) is built on top of the GraphQL API.
