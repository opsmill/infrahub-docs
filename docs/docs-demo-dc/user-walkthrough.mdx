...
This command creates a branch, loads the Arista design, waits for generator completion, loads the virtualization demo data (see the [virtual machine management tutorial](./virtualization.mdx)), then creates a proposed change.
