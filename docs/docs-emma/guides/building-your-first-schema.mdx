...
- Basic understanding of what schemas are (see [First Steps](../getting-started/first-steps.mdx))
...
**Solution**: Be more specific about data types in your description, for example: "IPv4 address" instead of "IP address"
...
- [Schema Builder Reference](../features/schema-builder.mdx) - Detailed Schema Builder documentation
